...
function displaySubtractQuestion(operand1, operand2) {
  // document.getElementById('operandi1').textContent = operand1 > operand2 ? operand1 : operand2;
  // document.getElementById('operandi2').textContent = operand1 > operand2 ? operand2 : operand1;
  if (operand1 < operand2) {
    return displaySubtractQuestion(operand2, operand1);
  } else if (operand1 === operand2) {
    return displaySubtractQuestion(operand1, operand2);
  }
  document.getElementById('operand1').textContent = operand1;
  document.getElementById('operand2').textContent = operand2;
  document.getElementById('operator').textContent = '-';
